;(function() {
	...
	// route provider
	.config(["$routeProvider", "$locationProvider", "JQ_LOAD", "FacebookProvider", function($routeProvider, $locationProvider, jqload, FacebookProvider) {
	  ...
	  */
	  FacebookProvider.init(myAppId);
		...
		$routeProvider.when("/pages/restaurant", {
			templateUrl: "views/pages/restaurant.html",
			controller: "loginCtrl"
		});

		$routeProvider.when("/pages/landing", {
